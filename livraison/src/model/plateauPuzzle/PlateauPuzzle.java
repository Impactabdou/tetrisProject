...
public class PlateauPuzzle extends AbstractModeleEcoutable {
	...
	public void initializeGame() {
		...
		while (this.listOfShapes.size() < maxShapes) {
			...
			int forme = (int) (Math.random() * 3) + 1;

			// Selection des position x,y du centre de la forme
			int row = (int) (Math.random() * this.height); 
			int col = (int) (Math.random() * this.width);
			...
			int pieceOrientation = (int) (Math.random() * 3);
	...
	public void rotateLeft(PiecePuzzle piece) throws OutOfMapException {
